...
<button {{ $attributes->class([
    ...
    'bg-blue-500 hover:bg-blue-700 text-white border-transparent focus:border-blue-300 focus:ring-blue-200' => !$customStyling && $primary,
    'bg-red-500 hover:bg-red-700 text-white border-transparent focus:border-red-700 focus:ring-red-200' => !$customStyling && $danger,
    'bg-white hover:bg-gray-100 text-gray-700 border-gray-300 focus:border-blue-300 focus:ring-blue-200' => !$customStyling && $secondary,
])->merge([
    'type' => $type
